...
const images = [
  '/images/projects/gifting/q1.jpeg',
  '/images/projects/gifting/q2.jpeg',
  '/images/projects/gifting/h1.jpeg',
  '/images/projects/gifting/h2.jpeg',
      ...
      <div className='max-w-7xl mx-auto'>
        ...
        <div className='text-center mb-20'>
          ...
          <p className='max-w-3xl mx-auto text-gray-600 text-lg'>
            Premium merchandising, gifting and branded corporate solutions executed by Xentum.
          </p>
        ...
        <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
          ...
          {images.map((img, i) => (
            ...
            >
              ...
              <Image
                src={img}
                alt={`Merchandising ${i + 1}`}
                fill
                className={`transition-all duration-700 ${
                  img === '/images/projects/gifting/q1.jpeg'
