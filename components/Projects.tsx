        ...
        <div className='max-w-7xl mx-auto px-4 md:px-6'>
          ...
          <div className='grid md:grid-cols-2 lg:grid-cols-3 gap-8'>
            ...
            {projects.map((project, index) => (
              <div
                key={index}
                className='group bg-white border border-gray-200 rounded-[32px] overflow-hidden shadow-sm hover:shadow-2xl hover:-translate-y-3 hover:border-yellow-500 transition-all duration-500'
              >
