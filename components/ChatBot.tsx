    ...
    <>
      {!open && (
        <button
          ...
          className='fixed bottom-24 md:bottom-28 right-4 md:right-8 z-[999] bg-yellow-500 text-black p-4 rounded-full shadow-[0_10px_30px_rgba(245,183,0,0.35)] hover:scale-110 transition-all duration-300'
        >
          <FaRobot size={32} />
        </button>
      )}
